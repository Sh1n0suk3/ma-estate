export const name = "Ma Estate";
export const ec1 = {
		property: 'eco-ma',
        name: 'Eco-Ma',
        description: 'The sustainable choice. Lasts 432+ years.',
        information: `
        ...
        `,
        features1: 'Self-Composting Walls',
        features2: 'Gravity-Optional Stairs',
        features3: 'Organic Mold Collection',
        features4: 'Windows (Mostly Close)',
        src: '/img/ecosmarta_cinematic2_composited.webp',
        alt: 'A 3D Model representing Ma house (disaster)',
        price: '56฿'
    };
export const ec2 = {
		property: 'not-very-eco-ma',
        name: 'Not Eco-Ma',
        description: 'Purely wood. Guaranteed to last no more than 432 years.',
        information: `
            ...
            <p style="color: darkred;">Avoid all contact with <strong>fire</strong>, <strong>water</strong>, or a stiff breeze. We are not responsible if your house spontaneously becomes a bonfire, a boat, or a pile of sawdust.</p>
        `,
        features1: 'Pre-Installed Termite Community',
        features2: '24/7 Creaking Soundtrack',
        features3: 'Extra-Splintery Surfaces',
        features4: 'Structural Failure Timer',
        src: '/img/ecosmarta_cinematic2_composited.webp',
        alt: 'A 3D Model representing Ma house (disaster)',
        price: '4,562,356฿'
    };
export const ec3 = {
		property: 'just-ma',
        name: 'Just Ma',
        description: 'The award-winning House by Ma. Officially the worst house design ever.',
        information: `
        ...
        `,
        features1: 'Doors to Existential Dread',
        features2: 'Non-Euclidean Hallways',
        features3: 'Useless Complimentary Compass',
        features4: 'Bathroom (In Another Dimension)',
        src: '/img/ecosmarta_cinematic2_composited.webp',
        alt: 'A 3D Model representing Ma house (disaster)',
        price: '72,386,214฿'
    };